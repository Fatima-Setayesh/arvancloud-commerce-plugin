...
│   ├── frontend/               # Customer dashboard, shortcodes, and views
...
Additional setup, UI, live-mode, and delivery guidance is available in [`docs/setup-guide.md`](docs/setup-guide.md), [`docs/ui-system.md`](docs/ui-system.md), [`docs/frontend-architecture.md`](docs/frontend-architecture.md), [`docs/live-api-checklist.md`](docs/live-api-checklist.md), and [`PROJECT_STATUS.md`](PROJECT_STATUS.md).
