...
$GLOBALS['wpdb'] = new Arvan_Test_Activation_Wpdb(); $GLOBALS['arvan_test_options'] = array(); $GLOBALS['arvan_test_schedules'] = array(); $GLOBALS['arvan_test_pages'] = array();
...
arvan_test_assert_same( 2, count( $pages ), 'activation did not create both customer pages' );
Arvan_Reseller_Activator::activate();
arvan_test_assert_same( 2, count( $GLOBALS['arvan_test_pages'] ), 'repeat activation duplicated customer pages' );
