	...
	async function renderSettings() {
		...
		try {
			...
			const panels = [
				...
				'<section><h2>قیمت‌گذاری فروشنده</h2><div class="ar-form-grid">' + settingField('reseller_share_percent', 'سهم فروشنده (درصد)', editableDecimal(settings.reseller_share_percent), 'number', 'حداکثر معتبر backend برابر ۲۰٪ است.', 'min="0" max="20" step="0.0001"') + settingField('currency', 'کد ارز', settings.currency, 'text', 'براساس قرارداد فعلی، مقدار پیش‌فرض IRR است.', 'dir="ltr" maxlength="3" pattern="[A-Za-z]{3}"') + '</div></section>',
