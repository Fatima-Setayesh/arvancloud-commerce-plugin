(function () {
	...
	async function saveSettings(form) {
		...
		data.email_notifications_enabled = Boolean(form.querySelector('[name="email_notifications_enabled"]:checked'));
	...
	function captureSettingsDraft() {
		...
		draft.email_notifications_enabled = form.querySelector('[name="email_notifications_enabled"]:checked') ? 1 : 0;
